...
```js title="Function component" 1:15
import React, { useState } from "react";
...
<UnOrderedList>
  ...
  <ListItem>Sharable state logic outside of the component.</ListItem>
  <ListItem>Simpler to write and have less template code.</ListItem>
</UnOrderedList>
<Grid columns={2}>
  <Steps>
    <p>
...
<Heading>useCallback and React.memo()</Heading>
<ImageLink
...
<UnOrderedList>
  ...
  <ListItem>
    Unlike the <i>useEffect</i> hook, it runs during the render time.
  </ListItem>
  <ListItem>
...
<Heading>useDebugValue</Heading>
<ImageLink
  src='https://github.com/bansalrachita/react-hooks-slides/blob/master/src/images/usedebugvalue.gif?raw=true'
  width='600px'
  height='250px'
/>
